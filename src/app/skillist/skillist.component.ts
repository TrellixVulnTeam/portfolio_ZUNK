...
export class SkillistComponent implements OnInit {
  ...
  cards=[
    ...
    {class:'css', title:'CSS3', content:" The best tool to bring styles to your web page. I make use of it features to create beautiful looking app."},
    ...
    {class:'java', title:'JAVA', content:"My first class-based, object-oriented programming, present everywhere. I have good understanding of Java codes."},
    {class:'scala', title:'SCALA', content:"My first ojbect-oriented/functional programming. The ideal tool to design and secure your softwares  ."}
  ]
